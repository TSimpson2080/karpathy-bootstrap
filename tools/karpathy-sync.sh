...
for repo in "${repos[@]}"; do
  ...
  cp "$SRC/docs/ai/KARPATHY_METHOD.md" "$SRC/docs/ai/TASK_TEMPLATE.md" "$dir/docs/ai/"
  cp "$SRC/scripts/check-placeholders.sh" "$dir/scripts/"; chmod +x "$dir/scripts/check-placeholders.sh"
